...
<link rel="shortcut icon" href="/favicon.ico" />
	...
	<link rel="stylesheet" href="plugins/eventCalendar/css/eventCalendar.css">

	<!-- Theme CSS file: it makes eventCalendar nicer -->
	<link rel="stylesheet" href="plugins/eventCalendar/css/eventCalendar_theme_responsive.css">
...
<link rel="stylesheet" type="text/css" media="all" href="plugins/barralateral/jScrollPane.css" />
	<script type="text/javascript" src="plugins/barralateral/jquery.min.js"></script>
	<script type="text/javascript" src="plugins/barralateral/jquery.mousewheel.js"></script>
	<script type="text/javascript" src="plugins/barralateral/jScrollPane.js"></script>
	<script type="text/javascript"><!--
	$(function()
	{
...
function refrescar(){
if(map=="on"){
//setTimeout(function(){$(location).attr('href','http://webtecnologia.tk/menu11.php?map=true')},1000);
}
}
if(zmap!=1){
setTimeout(function(){
...
$("#goback").click(function(){
  ...
  $("#calendario").hover(function(){
	var src = $("#calendat").attr("src").replace("Calendario.png", "CalendarioII.png");
    $("#calendat").attr("src", src);
	});
  $("#calendario").mouseleave(function(){
	var src = $("#calendat").attr("src").replace("CalendarioII.png", "Calendario.png");
    $("#calendat").attr("src", src);
	setTimeout(function(){
	$("#calendario").hide();},2);
	});
...
var link="http://webtecnologia.tk/menu.php?map=true";
...
var lnk1="http://webtecnologia.tk/menu.php?map=true&estado=1"
...
var lnk="http://webtecnologia.tk/menu.php?map=true&estado=0"
...
<!--Parte 3-->
  ...
  <tbody>
	...
	<img id="calendat" src="/iconos/Calendario.png" onmouseover="this.src='/iconos/CalendarioI.png';" onclick="this.src='/iconos/CalendarioII.png';" onmouseout="this.src='/iconos/Calendario.png';" height="20" width="20" style="position:absolute; left:92%; top:0%;"/>
		
	<div id="calendario" style="z-index:6; position:absolute; left:92%; top:18px; width:300px; height:250px; ">
	<div style="background-color:#FEFEFE; height:1px;"></div>
	<div style="background-color:#FDFDFD; height:1px;"></div>
	<div style="background-color:#FCFCFC; height:1px;"></div>
	<div style="background-color:#FBFBFB; height:1px;"></div>
	<div style="background-color:#FAFAFA; height:75%; color:black;">
	<table border="0" style="width:100%;">
	<tr>
	<td>
	<div style="position:relative; left:5%;"/>
	<span class="titlein">Calendario</span>
	</td>
	</tr>
	<tr>
	<td>
	<div id="eventCalendarHumanDate" style="position:absolute; left:5%;"/>
	</td>
	</tr>
	</table>
	</div>
	...
	<div id="panelref" style="z-index:6; position:absolute; left:96%; top:18px; width:175px; height:125px; ">
	<div style="background-color:#FEFEFE; height:1px;"></div>
	<div style="background-color:#FDFDFD; height:1px;"></div>
	<div style="background-color:#FCFCFC; height:1px;"></div>
	<div style="background-color:#FBFBFB; height:1px;"></div>
	...
	<td>
	<div style="position:relative; left:5%;"/>
	<span class="titlein">Refresco autom&aacute;tico</span><br><div style="position:relative; top:1%;"/>
	</td>
	</tr>
	<tr>
	<td>
...
<!--script src="plugins/eventCalendar/js/jquery.timeago.js" type="text/javascript"></script-->
<!--<script src="plugins/eventCalendar/js/jquery.eventCalendar.min.js" type="text/javascript"></script>-->
<script src="plugins/eventCalendar/js/jquery.eventCalendar.js" type="text/javascript"></script>
</html>
