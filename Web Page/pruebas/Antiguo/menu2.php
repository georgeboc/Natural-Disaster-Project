...
$("#goback").click(function(){
  ...
  $("#calendario").hover(function(){
	var src = $("#calendar").attr("src").replace("Calendario", "CalendarioII");
    $("#calendar").attr("src", src);
	});
  $("#calendario").mouseleave(function(){
	var src = $("#calendar").attr("src").replace("CalendarioII", "Calendario");
    $("#calendar").attr("src", src);
	setTimeout(function(){
	$("#calendario").hide();},2);
	});
...
<!--Parte 3-->
  ...
  <tbody>
	...
	<img id="calendar" src="/iconos/Calendario.png" onmouseover="this.src='/iconos/CalendarioI.png';" onclick="this.src='/iconos/CalendarioII.png';" onmouseout="this.src='/iconos/Calendario.png';" height="20" width="20" style="position:absolute; left:93%; top:0%;"/>
	...
	<div id="panelref" style="z-index:5; position:absolute; left:96%; top:18px; width:175px; height:125px; ">
	<div style="background-color:#FEFEFE; height:1px;"></div>
	<div style="background-color:#FDFDFD; height:1px;"></div>
	<div style="background-color:#FCFCFC; height:1px;"></div>
	<div style="background-color:#FBFBFB; height:1px;"></div>
