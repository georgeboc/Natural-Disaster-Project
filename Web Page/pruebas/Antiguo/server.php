 ...
 */
$server->register('Select', // Nombre de la funcion
...
//Register to DB
	$img="imagenes/".$nom;
	$conexion=mysql_connect("mysql.tk","u703089028_db","grmx1998");
	mysql_select_db("u703089028_db",$conexion);
...
function DB_COUNT(){
$conexion=mysql_connect("mysql.tk","u703089028_db","grmx1998") or 
  die("Problemas en la conexion");
mysql_select_db("u703089028_db",$conexion) or
